...
DMresults <- runTests(measurements, classes, crossValParams = crossValParams, verbose = 1)
```
...
DDresults <- runTests(measurements, classes,
                      ...
                      modellingParams = modellingParamsDD, verbose = 1)
DDresults
```
...
SVMresults <- runTests(measurements, classes, crossValParams = crossValParams,
                       modellingParams = SVMparams)
```
